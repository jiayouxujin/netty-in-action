package com.xuxiaojin.initializer;

import com.xuxiaojin.chooser.DefaultSpdyOrHttpChooser;
import com.xuxiaojin.server.DefaultServerProvider;
...
public class SpdyChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(SocketChannel ch) throws Exception {
        ...
        pipeline.addLast("chooser",new DefaultSpdyOrHttpChooser());
    }
}
